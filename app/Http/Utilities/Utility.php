...
class Utility{
    ...
    const EVENT_TYPE_WORKSHOP = 2;
    const EVENT_TYPE_CAMPIGN = 3;

    const MEDIA_TYPE_IMAGE = 1;
    const MEDIA_TYPE_VIDEO = 2;
    const MEDIA_TYPE_LINK = 3;

    const PROJECT_TYPE_UPCOMING = 0;
    const PROJECT_TYPE_ACTIVE = 1;
    ...
    protected  static $event_types = [
        self::EVENT_TYPE_EVENT => 'Events',
        self::EVENT_TYPE_WORKSHOP => 'Workshops',
        self::EVENT_TYPE_CAMPIGN => 'Campigns',
    ];
    public static function event_types()
    {
        return static::$event_types;
    }

    protected  static $media_types = [
    ...
    {
        return static::$media_types;
    }

    protected  static $project_types = [
        self::PROJECT_TYPE_ACTIVE => 'Active',
        self::PROJECT_TYPE_UPCOMING => 'Upcoming',
    ];
    public static function project_types()
    {
        return static::$project_types;
    }
