...
@section('title') {{ $research->title }} @endsection
        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 slider">
                ...
                <div id="propertiesDetailsSlider" class="carousel properties-details-sliders slide mb-60">
                    ...
                    <div class="carousel-inner">
                        <div class="active item carousel-item" data-slide-number="0">
                            <img src="{{ URL::asset(App\Models\Research::DIR_STORAGE . $research->image) }}" class="img-fluid" alt="properties-photo">
                        </div>
                ...
                <div class="property-description mb-60">
                    <h3 class="heading-3">{{ $research->title }}</h3>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="sidebar mbl">
                    ...
                    <div class="widget recent-posts">
                        ...
                        @foreach ($recentResearches as $recentResearch )
                        <div class="media mb-4">
                            <a href="{{ route('research_detail',['id'=>encrypt($recentResearch->id)]) }}">
                                <img src="{{ URL::asset(App\Models\Research::DIR_STORAGE . $recentResearch->image) }}" alt="sub-property">
                            </a>
                            <div class="media-body align-self-center">
                                <h5>
                                    <a href="{{ route('research_detail',['id'=>encrypt($recentResearch->id)]) }}">{{ $recentResearch->title }}</a>
                                </h5>
