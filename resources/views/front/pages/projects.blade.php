                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-12 col-pad">
                                <div class="property-thumbnail">
                                    <a href="{{ route('project_detail',['id'=>encrypt($project->id)]) }}" class="property-img">
                                        @if(!empty($project->image))
                                            <img src="{{ URL::asset('storage/projects/' . $project->image) }}" alt="property-box-5" class="img-fluid">
                                        @else
                            ...
                            <div class="col-lg-7 col-md-12 align-self-center col-pad">
                                <div class="detail">
                                    <!-- title -->
                                    <h1 class="title">
                                        <a href="{{ route('project_detail',['id'=>encrypt($project->id)]) }}">{{ $project->title }}</a>
                                    </h1>
                                    ...
                                    <!-- Location -->
                                    <div class="location">
                                        <a href="{{ route('project_detail',['id'=>encrypt($project->id)]) }}">
                                    ...
                                    <p style="text-align: right;"><a href="{{ route('project_detail',['id'=>encrypt($project->id)]) }}" class="text-primary">Read More</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
