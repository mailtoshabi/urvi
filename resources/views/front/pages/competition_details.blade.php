...
@section('title') {{ $competition->title }} @endsection
        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 slider">
                ...
                <div id="propertiesDetailsSlider" class="carousel properties-details-sliders slide mb-60">
                    ...
                    <div class="carousel-inner">
                        <div class="active item carousel-item" data-slide-number="0">
                            <img src="{{ URL::asset(App\Models\Competition::DIR_STORAGE . $competition->image) }}" class="img-fluid" alt="properties-photo">
                        </div>
                ...
                <div class="property-description mb-60">
                    <h3 class="heading-3">{{ $competition->title }}</h3>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="sidebar mbl">
                    ...
                    <div class="widget recent-posts">
                        ...
                        @foreach ($recentCompetitions as $recentCompetition )
                        <div class="media mb-4">
                            <a href="{{ route('competition_detail',['id'=>encrypt($recentCompetition->id)]) }}">
                                <img src="{{ URL::asset(App\Models\Competition::DIR_STORAGE . $recentCompetition->image) }}" alt="sub-property">
                            </a>
                            <div class="media-body align-self-center">
                                <h5>
                                    <a href="{{ route('competition_detail',['id'=>encrypt($recentCompetition->id)]) }}">{{ $recentCompetition->title }}</a>
                                </h5>
