                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-12 col-pad">
                                <div class="property-thumbnail">
                                    <a href="{{ route('campign_detail',['id'=>encrypt($event->id)]) }}" class="property-img">
                            ...
                            <div class="col-lg-7 col-md-12 align-self-center col-pad">
                                <div class="detail">
                                    <!-- title -->
                                    <h1 class="title">
                                        <a href="{{ route('campign_detail',['id'=>encrypt($event->id)]) }}">{{ $event->title }}</a>
                                    </h1>
                                    ...
                                    <!-- Location -->
                                    <div class="location">
                                        <a href="{{ route('campign_detail',['id'=>encrypt($event->id)]) }}">
                                    ...
                                    <p style="text-align: right;"><a href="{{ route('campign_detail',['id'=>encrypt($event->id)]) }}" class="text-primary">Read More</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
