                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-12 col-pad">
                                <div class="property-thumbnail">
                                    <a href="{{ route('workshop_detail',['id'=>encrypt($workshop->id)]) }}" class="property-img">
                                        @if(!empty($workshop->image))
                                            <img src="{{ URL::asset(App\Models\Event::DIR_STORAGE . $workshop->image) }}" alt="property-box-5" class="img-fluid">
                                        @else
                            ...
                            <div class="col-lg-7 col-md-12 align-self-center col-pad">
                                <div class="detail">
                                    <!-- title -->
                                    <h1 class="title">
                                        <a href="{{ route('workshop_detail',['id'=>encrypt($workshop->id)]) }}">{{ $workshop->title }}</a>
                                    </h1>
                                    @empty($workshop->location)

                                    @else
                                    <!-- Location -->
                                    <div class="location">
                                        <a href="{{ route('workshop_detail',['id'=>encrypt($workshop->id)]) }}">
                                    ...
                                    <p style="text-align: right;"><a href="{{ route('workshop_detail',['id'=>encrypt($workshop->id)]) }}" class="text-primary">Read More</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
