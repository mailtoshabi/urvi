...
<!-- Sub banner start -->
<div class="urvi_cosa sub-banner">
    <div class="container">
...
<!-- About us start -->
<div class="about-us content-area-7 bg-white" style="padding-top: 20px;">
    <div class="container">
        <div class="row">
                    ...
                    <div id="carouselExampleIndicators3" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset(Utility::FRONT_END.'assets/img/urvi_kosa2.jpg') }}" alt="Urvi Kosa" class="img-fluid">
                            </div>
                            <div class="carousel-item ">
                                <img src="{{ asset(Utility::FRONT_END.'assets/img/urvi_kosa.jpg') }}" alt="Urvi Kosa" class="img-fluid">
                            </div>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="about-info">
                    ...
                    {{-- <img src="{{ asset(Utility::FRONT_END.'assets/img/urvi_kosa2.jpg') }}" alt="Urvi Kosa" class="img-fluid" style="width: 50%"> --}}
                    <p>The history of Kerala in Vernacular Architecture is the still existing centuries old buildings constructed with locally available materials. The building culture currently in practice has been diverted a lot from the vernacular practices which caused over exploitation of natural resources and negative impact on the climate.
                        ...
                        <p><img src="{{ asset(Utility::FRONT_END.'assets/img/urvi_kosa.jpg') }}" alt="Urvi Kosa" class="img-fluid"></p>
