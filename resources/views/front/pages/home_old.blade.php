                ...
                <div class="row testimonial-info">
                    <div class="col-lg-6 col-md-12 col-pad none-992">
                        <div class="photo">
                            ...
                            @if(!empty($recentWorkshop->image))
                                <img src="{{ URL::asset(App\Models\Event::DIR_STORAGE . $recentWorkshop->image) }}" alt="property-box-5" class="img-fluid">
                            @else
        ...
        <div class="col-lg-12">
            <div class="row property-box-6">
                ...
                <div class="col-lg-6 col-pad align-self-center">
                    <div class="info">
                        <h3>
                            <a href="properties-details.html">Stone Free Movement</a>
                        </h3>
                        <p>Kerala faced one of the worst flood in 2018. It was a complete disaster and landslides. People realised the causes of the disaster is that uncontrolled quarrying and unprofessional developments. So we have suggested the idea of stone free construction techniques. So we are in a mission. Let’s stone free movement....
                            </p>
                        {{-- <a href="{{ route('about') }}" class="btn btn-4">Read more</a> --}}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="slick-slide-item">
                    <div class="blog-2">
                        ...
                        <div class="blog-one__single-text-box detail">
                            <h3 class="title">
                                <a href="{{ route('campigns') }}">Campigns</a>
                            </h3>
