        ...
        <div class="card mb-0">
            <div class="card-body">
                 <div class="row align-items-center">
                     <div class="col-md-6">
                         <div class="mb-3">
                             <h5 class="card-title">Projects <span class="text-muted fw-normal ms-2">({{ $projects->count() }})</span></h5>
                         </div>
                     </div>
                     ...
                     <div class="col-md-6">
                         <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                             ...
                             <div>
                                 <a href="{{ route('admin.projects.create') }}" class="btn btn-light"><i class="bx bx-plus me-1"></i> Add New</a>
                             </div>
                         ...
                         <tbody>
                             ...
                             <tr>
                                ...
                                <td>
                                   ...
                                   <img src="{{ URL::asset('storage/projects/' . $project->image) }}" alt="" class="avatar-sm rounded-circle me-2">
                               @else
                               ...
                               @endif
                                ...
                                <td>{{ Utility::project_types()[$project->type] }}</td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a href="{{ route('admin.projects.edit',encrypt($project->id)) }}" class="dropdown-item"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Edit</a></li>
                                            <li><a href="#" class="dropdown-item" data-plugin="delete-data" data-target-form="#form_delete_{{ $loop->iteration }}"><i class="mdi mdi-trash-can font-size-16 text-danger me-1"></i> Delete</a></li>
                                                <form id="form_delete_{{ $loop->iteration }}" method="POST" action="{{ route('admin.projects.destroy',encrypt($project->id)) }}">
                                                    @csrf
                                                    <input type="hidden" name="_method" value="DELETE" />
                                                </form>
                                            <li><a class="dropdown-item" href="{{ route('admin.projects.changeStatus',encrypt($project->id)) }}"><i class="mdi mdi-cursor-pointer font-size-16 text-success me-1"></i> {{ $project->status?'Deactivate':'Activate'}}</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
