...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', 'info@urvifoundation.org')); ?>" id="input-username" placeholder="Enter User Name" name="email">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Dason.</p><p>Crafted with <i class="mdi mdi-heart text-danger"></i> by Web Mahal</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/urvifoundation/public_html/admin_urvi/resources/views/auth/login.blade.php ENDPATH**/ ?>